create database phan_tich_hoat_dong_nguoi_dung;
use phan_tich_hoat_dong_nguoi_dung;
...
SELECT id_nguoi_dung, SUM(thoi_gian_doc_giay) AS tong_thoi_gian_doc FROM nhat_ky_nguoi_dung
GROUP BY id_nguoi_dung
ORDER BY tong_thoi_gian_doc DESC;

SELECT chuyen_muc, COUNT(*) AS so_luot_doc FROM nhat_ky_nguoi_dung
GROUP BY chuyen_muc;
...
SELECT id_nguoi_dung, AVG(thoi_gian_doc_giay) AS thoi_gian_trung_binh FROM nhat_ky_nguoi_dung
GROUP BY id_nguoi_dung
